...
sequenceDiagram
    ...
    participant Service as 💼 ChatMessagesService
    participant Repository as 🗄️ ChatMessagesRepository
    participant Database as 💾 Database

    Note over UI,Database: BƯỚC 1: Request Processing & Save User Message
